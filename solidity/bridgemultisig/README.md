...
BridgeMultisigWallet - modified version of the formally verified multisignature wallet (SafeMultisigWallet). Compiled by [TON Solidity Compiler](https://github.com/tonlabs/TON-Solidity-Compiler) (v 0.21 commit 1657b4f3541f19f3d23f87ac32800efe714bccc7).
This version doesn't have body size check and transaction expiration time is 1 day. 
...
Example:
```
> tonos-cli deploy BridgeMultisigWallet.tvc "{\"owners\":[\"0x723b2f0fa217cd10fe21326634e66106678f15d5a584babe4f576dffe9dcbb1b\",\"0x127e3ca223ad429ddaa053a39fecd21131df173bb459a4438592493245b695a3\",\"0xc2dd3682ffa9df97a968bef90b63da90fc92b22163f558b63cb7e52bfcd51bbb\"],\"reqConfirms\":2}" --abi BridgeMultisigWallet.abi.json --sign deploy.keys.json
```


## 2.2. Download contract files 

Download compiled `.abi.json` and `.tvc` multisignature contract files from https://github.com/broxus/ton-labs-contracts/tree/master/solidity/bridgemultisig

`BridgeMultisigWallet.abi.json` direct link:

https://raw.githubusercontent.com/broxus/ton-labs-contracts/master/solidity/bridgemultisig/BridgeMultisigWallet.abi.json

 `BridgeMultisigWallet.tvc` direct link:

https://github.com/broxus/ton-labs-contracts/raw/master/solidity/safemultisig/BridgeMultisigWallet.tvc
...
```
tonos-cli genaddr BridgeMultisigWallet.tvc BridgeMultisigWallet.abi.json --setkey <deploy.keys.json> --wc <workchain_id>
```
...
```bash
$ tonos-cli genaddr --genkey key.json --wc -1 BridgeMultisigWallet.tvc BridgeMultisigWallet.abi.json
Config: /home/user/tonos-cli.conf.json
Input arguments:
     tvc: BridgeMultisigWallet.tvc
      wc: -1
    keys: key.json
init_data: None
is_update_tvc: None
...
```
tonos-cli call <source_address> submitTransaction '{"dest":"<raw_address>","value":<nanotokens>,"bounce":false,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign "<source_seed_or_keyfile>"
```
...
```
tonos-cli call <multisig_address> sendTransaction '{"dest":"raw_address","value":0,"bounce":true,"flags":130,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign <seed_or_keyfile>
```
...
```bash
$ tonos-cli call 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc submitTransaction '{"dest":"-1:0c5d5215317ec8eef1b84c43cbf08523c33f69677365de88fe3d96a0b31b59c6","value":234000000,"bounce":false,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign k1.keys.json
Config: /home/user/tonos-cli.conf.json
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  ...
  params: {"dest":"-1:0c5d5215317ec8eef1b84c43cbf08523c33f69677365de88fe3d96a0b31b59c6","value":234000000,"bounce":false,"allBalance":false,"payload":""}
     abi: BridgeMultisigWallet.abi.json
    keys: k1.keys.json
lifetime: None
  output: None
...
```
tonos-cli call <source_address> confirmTransaction '{"transactionId":"<id>"}' --abi BridgeMultisigWallet.abi.json --sign "<source_seed_or_keyfile>"
```
...
```
$ tonos-cli call 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc confirmTransaction '{"transactionId":"6981478983724354305"}' --abi BridgeMultisigWallet.abi.json --sign k2.keys.json
Config: default
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
...
```
tonos-cli deploy BridgeMultisigWallet.tvc '{"owners":["0x...", ...],"reqConfirms":N}' --abi BridgeMultisigWallet.abi.json --sign <deploy_seed_or_keyfile> --wc <workchain_id>
```
...
```bash
$ tonos-cli deploy --sign key.json --wc -1 --abi BridgeMultisigWallet.abi.json BridgeMultisigWallet.tvc '{"owners":["0x88c541e9a1c173069c89bcbcc21fa2a073158c1bd21ca56b3eb264bba12d9340"],"reqConfirms":1}'
Config: /home/user/tonos-cli.conf.json
Input arguments:
     tvc: BridgeMultisigWallet.tvc
...
```
tonos-cli run <multisig_address> getCustodians {} --abi BridgeMultisigWallet.abi.json
```
...
```
$ tonos-cli run 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc getCustodians {} --abi BridgeMultisigWallet.abi.json
Config: default
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
...
```
tonos-cli run <multisig_address> getTransactions {} --abi BridgeMultisigWallet.abi.json
```
...
```bash
$ tonos-cli run 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc getTransactions {} --abi BridgeMultisigWallet.abi.json
Config: /home/user/tonos-cli.conf.json
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
...
```
tonos-cli call <multisig_address> submitTransaction '{"dest":"raw_address","value":<nanotokens>,"bounce":true,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign <seed__or_keyfile>
```
...
```bash
$ tonos-cli call 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc submitTransaction '{"dest":"-1:0c5d5215317ec8eef1b84c43cbf08523c33f69677365de88fe3d96a0b31b59c6","value":234000000,"bounce":true,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign k1.keys.json
Config: /home/user/tonos-cli.conf.json
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  method: submitTransaction
...
```bash
tonos-cli callex submitTransaction <multisig_address> BridgeMultisigWallet.abi.json <seed_or_keyfile> --dest <raw_address> --value <tokens>T --bounce <true|false> --allBalance <true|false> --payload ""
```
...
> **Note**: Due to a bug setting `allBalance` to `true` currently causes errors. Single-custodian multisig wallets may use `sendTransaction` method with flag `130` and value `0` instead:
```
tonos-cli callex sendTransaction <multisig_address> BridgeMultisigWallet.abi.json <seed_or_keyfile> --dest <raw_address> --value 0 --bounce <true|false> --flags 130 --payload ""
```

Example:

```bash
$ tonos-cli callex submitTransaction 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc BridgeMultisigWallet.abi.json k1.keys.json --dest -1:0c5d5215317ec8eef1b84c43cbf08523c33f69677365de88fe3d96a0b31b59c6 --value 0.234T --bounce false --allBalance false --payload ""
Config: /home/user/tonos-cli.conf.json
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  method: submitTransaction
...
```
tonos-cli call <multisig_address> confirmTransaction '{"transactionId":"<id>"}' --abi BridgeMultisigWallet.abi.json --sign <seed_or_keyfile>
```
...
```bash
tonos-cli callex confirmTransaction <multisig_address> BridgeMultisigWallet.abi.json <seed_or_keyfile> --transactionId <id>
```
...
```bash
$ tonos-cli callex confirmTransaction 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc BridgeMultisigWallet.abi.json k2.keys.json --transactionId 6982528395137505473
Config: default
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  method: confirmTransaction
...
```
tonos-cli message <multisig_address> submitTransaction '{"dest":"raw_address","value":<nanotokens>,"bounce":true,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign <seed_or_keyfile> --lifetime 3600
```
`"dest"` - raw address of a destination smart contract. Example: `"0:f22e02a1240dd4b5201f8740c38f2baf5afac3cedf8f97f3bd7cbaf23c7261e3"`.
...
> **Note**: Due to a bug setting `allBalance` to `true` currently causes errors. Single-custodian multisig wallets may use `sendTransaction` method with flag `130` and value `0` instead:
```
tonos-cli message <multisig_address> sendTransaction '{"dest":"raw_address","value":0,"bounce":true,"flags":130,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign <seed_or_keyfile> --lifetime 3600
```
...
```
$ tonos-cli message 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc submitTransaction '{"dest":"0:255a3ad9dfa8aa4f3481856aafc7d79f47d50205190bd56147138740e9b177f3","value":567000000,"bounce":true,"allBalance":false,"payload":""}' --abi BridgeMultisigWallet.abi.json --sign k1.keys.json --lifetime 3600
Config: default
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  method: submitTransaction
...
```
tonos-cli message <multisig_address> confirmTransaction '{"transactionId":"<id>"}' --abi BridgeMultisigWallet.abi.json --sign "<seed_or_keyfile>" --lifetime 600
```
`transactionId` – the ID of the transaction can be acquired from the custodian who created it, or by requesting the list of transactions awaiting confirmation from the multisignature wallet.
...
```
$ tonos-cli message 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc confirmTransaction '{"transactionId":"6982528395137505473"}' --abi BridgeMultisigWallet.abi.json --sign k3.keys.json --lifetime 600
Config: default
Input arguments:
 address: 0:a4629d617df931d8ad86ed24f4cac3d321788ba082574144f5820f2894493fbc
  method: confirmTransaction
...
```bash
$ tonos-cli deploy_message --raw --output deploy.boc --sign key.json --wc -1 --abi BridgeMultisigWallet.abi.json BridgeMultisigWallet.tvc '{"owners":["0x88c541e9a1c173069c89bcbcc21fa2a073158c1bd21ca56b3eb264bba12d9340"],"reqConfirms":1}'
Config: /home/user/tonos-cli.conf.json
Input arguments:
     tvc: BridgeMultisigWallet.tvc
  params: {"owners":["0x88c541e9a1c173069c89bcbcc21fa2a073158c1bd21ca56b3eb264bba12d9340"],"reqConfirms":1}
...
```
tonos-cli send --abi BridgeMultisigWallet.abi.json "message"
```
...
```bash
$ tonos-cli send --abi BridgeMultisigWallet.abi.json ""
Config: /home/user/tonos-cli.conf.json
Input arguments:
